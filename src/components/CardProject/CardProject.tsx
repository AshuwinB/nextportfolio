    ...
    <div className="container mx-auto px-4">
      ...
      <div className=" grid grid-cols-1 md:col-span-2 gap-4 lg:grid-cols-2 mb-4">
        {data.map((item: any, index: number) => (
          <div
            key={index}
            className="max-w-sm hover:bg-stone-200 bg-white border mt-5 h-fit border-gray-200 rounded-lg shadow  dark:border-gray-700"
          >
            ...
            <div className="p-5">
              ...
              <p className="mb-3 font-normal text-gray-700 ">{item.about}.</p>
